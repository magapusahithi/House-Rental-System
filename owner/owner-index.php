          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="province" required="required">
                                ...
                                <option value="Madhya Pradesh">Bagmati Pradesh</option>
                                <option value="Tamil Nadu">Gandaki Pradesh</option>
                                <option value="Kerala">Province No. 5</option>
                                <option value="Maharasthra">Karnali Pradesh</option>
                                <option value="Goa">Sudurpaschim Pradesh</option>
              </select>
            </div>
