...
if(!empty($_FILES['id_photo'])){
	...
	global $owner_id,$full_name,$email,$password,$phone_no,$address,$errors,$db;
	...
	$password = md5($password); // Encrypt password
		$sql = "INSERT INTO owner(owner_id,full_name,email,password,phone_no,address,id_photo) VALUES('$owner_id','$full_name','$email','$password','$phone_no','$address','$id_photo','$path')";
